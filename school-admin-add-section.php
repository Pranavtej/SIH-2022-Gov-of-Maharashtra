...
if(isset($_POST['submit']))
{
	...
	$insert = "INSERT INTO classes ( class_id,class,section) 
			VALUES ('$class_id','$class','$sec')";
	$insert2 = mysqli_query($con,$insert);
    $insert = "INSERT INTO schoolwise_class_details (school_id,class_id,teacher_id) 
			VALUES ('$school_id','$class_id','$teacher_id')";
	$insert2 = mysqli_query($con,$insert);
										...
										<div class="row">
											...
											<div class="col-12 col-sm-6">
												<div class="form-group">
													<label>Class</label>
													<div>
														<input type="num" name="class" class="form-control">
													</div>
												</div>
											</div>
