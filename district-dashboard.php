...
$sql2=mysqli_query($con,"select count(block_id) as total,block_id from blocks where district_id='$did'");
...
$sql12=mysqli_query($con,"select count(student_id) as total from exam_totals where school_id=
ANY(select school_id from school_info where district_id='$did') and eid="AEE" and status="p" group by school_id"); 
$i=0;
